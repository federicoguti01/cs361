...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints PART TIME EMPLOYEE because it the method is overridden
		// emp3.getHourlyRate(); // returns syntax error because the method doesn't exist in Employee class
...
//		 PartTimeEmployee pEmp3 = (PartTimeEmployee) emp1;
		...
		// because superclass Employee cannot be cast to subclass PartTimeEmployee
